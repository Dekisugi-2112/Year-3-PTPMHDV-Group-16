...
import { StoreContext } from '../../context/StoreContext' // <-- thêm import này

const Navbar = ({ setShowLogin }) => {

    const [menu, setMenu] = useState("home");
    const { token, setToken } = useContext(StoreContext); // <-- dùng StoreContext
                ...
                {!token
                    ...
                    : <div className='navbar-profile'>
                        ...
                        <ul className="nav-profile-dropdown">
                            <li><img src={asset.bag_icon} alt="" /><p>Orders</p></li>
                            <hr />
